//
//  SelectVerbsTableViewSell.swift
//  IrregularVerbs
//
...
final class SelectVerbsTableViewSell: UITableViewCell {
    ...
    func configure(with verb: Verb, isSelected: Bool) {
        ...
        checkboxImageView.image = isSelected ? State.select.image :
            State.unselect.image
    }
